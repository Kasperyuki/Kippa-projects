...
if __name__ == "__main__":
    paiva = input("Select date (YYYYMMDD): ")
    print("Please note that downloadable radar imagery ranges from current time to previous day!")
    tunti = int(input("Hour: "))
    minuutti = int(input("Minute: "))
    img_count = int(input("Picture count (1d = 288):"))
